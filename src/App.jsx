  ...
  return (
    <div className={`font-sans antialiased text-gray-900 bg-paper-texture transition-colors duration-500`}>
      ...
      <div className="min-h-screen flex flex-col items-center p-4 md:p-8 relative">
          ...
          <nav className="flex space-x-4">
            {['education', 'skills', 'projects', 'contact'].map((section) => (
              <a
                key={section}
                href={`#${section}`}
                className="text-sm md:text-base font-bold uppercase hover:text-red-500 hover:scale-110 transition-transform duration-300"
              >
                {section}
              </a>
            ))}
        ...
        <motion.section
          id="hero"
          className="w-full max-w-4xl min-h-screen flex flex-col justify-center items-start text-left py-16"
          ...
          >
            <div className="flex gap-4">
              <motion.a
                ...
                className="px-6 py-3 font-semibold border-2 border-black bg-white text-black shadow-sketch transition-all duration-300 flex items-center gap-2"
                whileHover="hover"
                whileTap="tap"
              ...
              <motion.a
                href="https://leetcode.com/trisharaj11"
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 font-semibold border-2 border-black bg-white text-black shadow-sketch transition-all duration-300 flex items-center gap-2"
                whileHover="hover"
        ...
        <Section title="Skills" id="skills">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
            <SkillCategory title="Programming Languages" skills={['C++', 'Python', 'JavaScript']} />
            <SkillCategory title="Frontend" skills={['HTML', 'CSS', 'React', 'Tailwind CSS']} />
            <SkillCategory title="Backend" skills={['Node.js', 'Express.js', 'MongoDB', 'Mongoose', 'SQL']} />
            <SkillCategory title="Tools/Tech" skills={['Git', 'GitHub', 'Postman', 'Docker', 'Cloudinary']} />
            <SkillCategory title="CS Fundamentals" skills={['OOPs', 'OS', 'DSA', 'DBMS', 'DAA']} />
          </div>
        </Section>
