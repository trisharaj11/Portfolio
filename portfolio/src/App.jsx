...
<Section title="Skills" id="skills">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
    ...
    <ProjectCard
      title="Resume Builder using AI feature"
      description="Developed a full-stack AI-powered Resume Builder using the MERN stack (MongoDB, Express.js, React.js, Node.js) to generate professional resumes with intelligent content suggestions."
      githubLink="https://github.com/trisharaj11/resumeBuilder"
      liveLink="https://resume-builder-c487.vercel.app/"
    />
